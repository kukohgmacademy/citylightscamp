...
cards = {
    1: """            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <h3><a href="5 Barang Wajib Bawa Saat Paket Camping di Coban Talun.html" style="color: #fff;">5 Barang Wajib Bawa Saat Paket Camping di Coban Talun</a></h3>
                    ...
                    <a href="5 Barang Wajib Bawa Saat Paket Camping di Coban Talun.html" style="margin-top: auto; font-weight: 600;" aria-label="Membaca blog 1">Baca Artikel <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>""",
    2: """            <div class="card">
                <div class="card-img">
                ...
                <div class="card-content">
                    ...
                    <h3><a href="3 Spot Foto Paling Instagramable di Area Camping.html" style="color: #fff;">3 Spot Foto Paling Instagramable di Area Camping</a></h3>
                    <p>Temukan sudut-sudut rahasia Batu Malang yang hanya bisa diakses via rute camping. Foto liburanmu dijamin estetik!</p>
                    <a href="3 Spot Foto Paling Instagramable di Area Camping.html" style="margin-top: auto; font-weight: 600;" aria-label="Membaca blog 2">Baca Artikel <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>""",
    3: """            <div class="card">
                <div class="card-img">
                ...
                <div class="card-content">
                    ...
                    <h3><a href="Amankah Paket Camping Untuk Anak-anak dan Keluarga.html" style="color: #fff;">Amankah Paket Camping Untuk Anak-anak dan Keluarga?</a></h3>
                    ...
                    <a href="Amankah Paket Camping Untuk Anak-anak dan Keluarga.html" style="margin-top: auto; font-weight: 600;" aria-label="Membaca blog 3">Baca Artikel <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>""",
    4: """            <div class="card">
                <div class="card-img">
                ...
                <div class="card-content">
                    ...
                    <h3><a href="Keseruan BBQ dan Api Unggun di Camping Batu Malang.html" style="color: #fff;">Keseruan BBQ dan Api Unggun di Camping Batu Malang</a></h3>
                    <p>Malam hari di kawasan Batu terkenal dingin, namun di sanalah letak keistimewaan aktivitas api unggun dan BBQ.</p>
                    <a href="Keseruan BBQ dan Api Unggun di Camping Batu Malang.html" style="margin-top: auto; font-weight: 600;" aria-label="Membaca blog 4">Baca Artikel <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>""",
    5: """            <div class="card">
                <div class="card-img">
                ...
                <div class="card-content">
                    ...
                    <h3><a href="Waktu Terbaik untuk Camping Menikmati City Light Batu Malang.html" style="color: #fff;">Waktu Terbaik untuk Camping Menikmati City Light Batu Malang</a></h3>
                    <p>Memilih waktu yang tepat adalah kunci utama agar pengalaman camping tidak terganggu cuaca buruk atau kabut tebal.</p>
                    <a href="Waktu Terbaik untuk Camping Menikmati City Light Batu Malang.html" style="margin-top: auto; font-weight: 600;" aria-label="Membaca blog 5">Baca Artikel <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>""",
    6: """            <div class="card">
                <div class="card-img">
                ...
                <div class="card-content">
                    ...
                    <h3><a href="Mengenal Keunggulan Sewa Tenda Premium Batu Malang.html" style="color: #fff;">Mengenal Keunggulan Sewa Tenda Premium Batu Malang</a></h3>
                    ...
                    <a href="Mengenal Keunggulan Sewa Tenda Premium Batu Malang.html" style="margin-top: auto; font-weight: 600;" aria-label="Membaca blog 6">Baca Artikel <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>"""
}
